              ...
              <div class="modal-body mt-2">
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-md-7">
                    ...
                    <div class="form-group">
                      <div class="form-line">
                        <select class="form-control select2 product_class_add" name="requisitions_iopiop[]" required multiple>
    ...
    $.getJSON(url, function(result) {
      ...
      $.each(result, function(i, field) {
        ...
        tableRow += '<tr>\
                ...
                <td style="max-width:100px; padding-left: 5px !important"><input class="form-control requisitions_product_qty" name="requisitions_product_qty[]" type="number" onkeyup="return checkLimitorNot(this)" placeholder="Quantity .. " required></td>\
                <td style="max-width:50px; padding-left: 5px !important"><input class="form-control stock" type="text" value="' + item_dts[2] + '" readonly></td>\
                <td style="max-width:50px; padding-left: 5px !important"><input class="form-control limit-stock" type="text" value="' + item_dts[3] + '" readonly></td>\
                <td style="max-width:50px; padding-left: 5px !important"><input class="form-control received-stock" type="text" value="' + item_dts[4] + '" readonly></td>\
                <td style="max-width:60px; padding-left: 5px !important"><input class="form-control limit-yes-no" type="text" value="' + ache + '" readonly></td>\
