    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="header">
                        <span class="h4 mt-2"><?php echo $_SESSION['MONTHLY_STK_IN']; ?></span>
                    </div>
                    <div class="body">
                        <form action="<?php echo url('stocks/monthly_stock_in_report_view'); ?>" target="_blank" method="post" enctype="multipart/form-data">
