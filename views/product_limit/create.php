              ...
              <div class="modal-body mt-2">
                ...
                <div class="row clearfix">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <div class="form-line">
                        <input type="date" id="product_limit_date" name="product_limit_date" class="form-control" value="<?php echo date('Y-m-d'); ?>">
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <table class="table table-responsive">
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="max-width: 80px;"><input type="hidden" name="product_limit_product[]" value="<?php echo $p1['product_id']; ?>"><input type="number" name="product_limit_requisition_limit[]" class="form-control" placeholder="<?php echo $_SESSION['QTY']; ?>"></td>
                          <td style="max-width: 80px;">
                            <select class="form-control" name="product_limit_status[]" required>
                              <option value="1"><?php echo $_SESSION['LANGUAGE_SETTED']=='en'?'Allow':'অনুমোদিত'; ?></option>
                              <option value="0"><?php echo $_SESSION['LANGUAGE_SETTED']=='en'?'Not-allow':'অনুমতি নেই'; ?></option>
                            </select>
                          </td>
                        </tr>
                      <?php } ?>
                    ...
                    <table class="table table-responsive">
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="max-width: 80px;"><input type="hidden" name="product_limit_product[]" value="<?php echo $p2['product_id']; ?>"><input type="number" name="product_limit_requisition_limit[]" class="form-control" placeholder="QTY"></td>
                          <td style="max-width: 80px;">
                            <select class="form-control" name="product_limit_status[]" required>
                            <option value="1"><?php echo $_SESSION['LANGUAGE_SETTED']=='en'?'Allow':'অনুমোদিত'; ?></option>
                              <option value="0"><?php echo $_SESSION['LANGUAGE_SETTED']=='en'?'Not-allow':'অনুমতি নেই'; ?></option>
