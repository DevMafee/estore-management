...
<html>
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title><?php echo base_url('title'); ?> | Failed</title>
    ...
    ?>
                    <div class="authentication-layout-tab-area">
                        <div id="signin">
                            ...
                            <h4 class="text-white">Please Try Again to get the New Password.</h4>
                            
                            <div class="simec-pos-input-group text-right" style="text-align:right;">
                                <a href="<?php echo url('password_reset'); ?>" class="simec-pos-submit-bitton text-white">Try Again</a>
                            </div>
                        </div>
                    </div>
                </div>
