                  ...
                  ?>
                    <tr>
                      ...
                      <td class="align-middle">
                        ...
                        <a href="#" class="btn bg-cyan btn-circle waves-effect waves-circle waves-float" data-toggle="modal" data-target="#ChangePassword<?php echo $value['user_id']; ?>">
                    ...
                    <div class="modal fade" id="Edit<?php echo $value['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo url('employee_information/update_user'); ?>" method="post" enctype="multipart/form-data">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <small class="form-text text-danger"><?php echo isset($_SESSION['full_name']) ? $_SESSION['full_name'] : '';
                                                                          $_SESSION['full_name'] = ""; ?></small>
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <small class="form-text text-danger"><?php echo isset($_SESSION['username']) ? $_SESSION['username'] : '';
                    ...
                    <div class="modal fade" id="ChangePassword<?php echo $value['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <form action="<?php echo url('employee_information/update_password'); ?>" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
                              <div class="card">
                                <div class="card-body" style="padding: 20px !important;">
                                  <input type="hidden" name="user_id_md5" value="<?php echo $value['user_id_md5']; ?>">
                                  <input type="hidden" name="user_id" value="<?php echo $value['user_id']; ?>">
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="username">User Name</label>
                                        <input type="text" class="form-control" id="username" name="username" value="<?php echo $value['username']; ?>" readonly>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="new_password">New Password</label>
                                        <input type="password" class="form-control" id="new_password" name="new_password" placeholder="Type New Password ..">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <div class="modal fade" id="Delete<?php echo $value['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo url('employee_information/delete_user'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal fade" id="Retrive<?php echo $value['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo url('employee_information/undodelete_user'); ?>" method="post" enctype="multipart/form-data">
                            <?php $_SESSION['csrf_token' . $value['user_id_md5']] = md5(rand()); ?>
                            <div class="modal-body">
                              <div class="card card-fluid">
                                <div class="card-body">
                    ...
                    <div class="modal fade" id="Active<?php echo $value['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo url('employee_information/active_user'); ?>" method="post" enctype="multipart/form-data">
                            <?php $_SESSION['csrf_token' . $value['user_id_md5']] = md5(rand()); ?>
                            <div class="modal-body">
                              <div class="card card-fluid">
                                <div class="card-body">
