	...
	<div class="container-fluid">
	    <div class="row clearfix">
            <div class="col-12 col-lg-12 col-xl-12">
                <div class="card">
              	    <div class="header">
              		    <span class="h4 mt-2"><?php echo $_SESSION['DIST_AT_SECTION_RPT']; ?></span>
              	    </div>
                    <div class="body">
                        <form action="<?php echo url('stocks/section_wise_report'); ?>" target="_blank" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body mt-2">
                                <div class="row clearfix">
                                    <div class="col-md-3">
                                        <label for="from_date"><?php echo $_SESSION['SECTION']; ?></label>
